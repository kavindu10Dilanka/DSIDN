    ...
    <div class="">
      <q-card class="my-card">
        <q-card-section class="bg-blue-grey-10 text-white">
          <div class="text-h5">Rejected To be Returned DN forms</div>
      ...
      <q-item v-for="DN in DnForm" :key="DN.id">
        <div style="width: 1000px">
          <q-expansion-item
            ...
            @show="startCounting"
            @hide="stopCounting"
            header-class="bg-red-5 text-black"
          ...
          >
              ...
              <q-card-section>
                ...
                <div class="text-subtitle2">{{ DN.CommentTBR }}</div>
              </q-card-section>
            </q-card>
            ...
            <q-card>
              <q-card-section>
                <q-item-section>
                  <q-item-label class="bg-amber text-h6 text-center"
                  ...
                  <div class="q-pa-md">
                    <q-table
                      card-class="bg-amber text-black"
                      title="Items"
                      :rows="DN.rows"
                      :columns="columns"
                      row-key="name"
